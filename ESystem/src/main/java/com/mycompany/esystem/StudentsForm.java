...
public class StudentsForm extends javax.swing.JFrame {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            try {
                ...
                // Grant SELECT privileges on the current database
                ...
                System.out.println("Granted SELECT privileges to " + username + " on database " + escapedDB);
    ...
    try {
        ...
        // Get the username (Studid + Name)
        String getUsernameSQL = String.format(
            "SELECT CONCAT(ID, Name) AS username FROM students WHERE ID = %d", 
            studentId);
        ...
        // Revoke privileges if username exists and is not root
       // Revoke privileges if username exists and is not root
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        ...
        try {
            int studentId = Integer.parseInt(Studid.getText().trim());
