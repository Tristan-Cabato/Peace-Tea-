...
public class TeacherForm extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Teacher teacher = new Teacher();
        teacher.UpdateRecord(Integer.parseInt(Tid.getText()), Tname.getText(), Tadd.getText(), Integer.parseInt(Tcontact.getText()), Tdept.getText());
        showRecords();
        showClassList();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Teacher teacher = new Teacher();
        teacher.DeleteRecord(Integer.parseInt(Tid.getText()));
        showRecords();
        showClassList();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            int subjectId = Integer.parseInt(model.getValueAt(selectedRow, 0).toString());
            int teacherId = Integer.parseInt(Tid.getText());
            
            // Check if already assigned
            String checkQuery = "SELECT COUNT(*) FROM Assign WHERE subid = " + subjectId + " AND tid = " + teacherId;
            ESystem.rs = ESystem.st.executeQuery(checkQuery);
            if (ESystem.rs.next() && ESystem.rs.getInt(1) > 0) {
                JOptionPane.showMessageDialog(this, "This subject is already assigned to the teacher");
                return;
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // Handle Unassign Subject button
